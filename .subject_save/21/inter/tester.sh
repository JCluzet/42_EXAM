...
#    Updated: 2022/05/18 18:48:17 by jcluzet          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
bash .system/auto_correc_program.sh $FILE "Oupsi" "Oups"
if [ -e .system/verif/traceback ];then
    mv .system/verif/traceback .
	exit 1
fi

bash .system/auto_correc_program.sh $FILE "Manger pour vivre" "Vivre pour manger"
if [ -e .system/verif/traceback ];then
    mv .system/verif/traceback .
	exit 1
fi
